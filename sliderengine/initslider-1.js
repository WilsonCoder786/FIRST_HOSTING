jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"blocks,elastic,threedflipwithzoom,threedwithzoom,flip,threedflip,cssslide,threedtiles,slide,crossfade,fade,shuffle,threedhorizontal,blinds,threed",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
